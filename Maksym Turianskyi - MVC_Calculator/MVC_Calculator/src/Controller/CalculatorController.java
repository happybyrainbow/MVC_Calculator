...
public class CalculatorController {
    ...
    public void add(){
        ...
        //result=new Fraction(f1.getNum() * f2.getDenom() + f2.getNum() * f1.getDenom(), f2.getDenom() * f1.getDenom());
        result.shorten();
    }
    ...
    public void multiply(){
        ...
        //f1.expand(factor2);
        //f2.expand(factor1);
        result=new Fraction(f1.getNum()*f2.getNum(), f2.getDenom() * f1.getDenom());
        result.shorten();
    }
    ...
    public void divide(){
        ...
        //f1.expand(factor2);
        //f2.expand(factor1);
        result=new Fraction(f1.getNum()*f2.getDenom(), f2.getNum() * f1.getDenom());
        result.shorten();
    }
